...
def insert_data_to_db(application_name, ip, packets_sent, packet_loss, avg_latency, isp, local_isp):
    try:
        ...
        insert_query = """
        INSERT INTO public.PINGAPP (application_name, ip, packets_sent, packet_loss, avg_latency, isp, local_isp)
        VALUES (%s, %s, %s, %s, %s, %s, %s)
        """
        cursor.execute(insert_query, (application_name, ip, packets_sent, packet_loss, avg_latency, isp, local_isp))
        connection.commit()
